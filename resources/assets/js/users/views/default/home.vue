    ...
    <div class="col-12 home-ghost__section-1">
      <nav class="navbar navbar-toggleable-md navbar-light bg-faded">
        ...
        <form class="form-inline my-2 my-lg-0">
          <router-link class="hidden-xs-down mr-4" :to="{ name: 'plan' }"
            >START YOUR FREE TRIAL</router-link
          >
          <router-link
      ...
      <div class="hidden-lg-down ovarlay-lg"></div>
      <div class="hidden-xl-up ovarlay-lg ovarlay-sm"></div>
      <div class="details">
      ...
      <div class="col-12 mt-5 select-plan">
        ...
        <div class="mt-5">
          <div class="col-sm-10 offset-sm-1">
            <div class="row">
              <div
                class="col-12 col-sm-4 col mt-3 text-center card-columns-plan"
              ...
              >
                <div
                  class="card-plan"
                  :class="{ active: plan === item.plan_id }"
                >
                  <h3>{{ item.plan_name }}</h3>
                  <h1>
                    ${{ item.plan_amount / 100 }}
                    <small>/mo</small>
                  </h1>
                  <i v-if="item.plan_trial !== null"
                    >{{ item.plan_trial }} days free</i
                  >
                </div>
              </div>
            </div>
